...
namespace Asandului_Oana_Maria_Insurance.Controllers
{
    public class ProvidersController : Controller
    {
        ...
        public ProvidersController(InsuranceContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ProviderID,Name,Phone")] Provider provider)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProviderID,Name,Phone")] Provider provider)
        {
